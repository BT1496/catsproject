...
echo "Done, catscoind's shut down. To rerun/poke around:"
echo "${1}/catscoind -datadir=$D1 -daemon"
echo "${1}/catscoind -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall catscoind; rm -rf test.*"
exit 0
