...
#ifndef H_catscoin_SCRIPT
#define H_catscoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CcatscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, catscoin always counted CHECKMULTISIGs
