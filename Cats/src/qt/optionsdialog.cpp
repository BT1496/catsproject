    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new catscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->catscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Cats."), QMessageBox::Ok);
