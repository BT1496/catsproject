...
allowing somebody to distribute a Bitcoin-Qt.app or catscoin-qt-setup.exe with a valid
...
that the catscoin-qt.exe file inside the installer had not been tampered with.
