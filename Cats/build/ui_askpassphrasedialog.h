...
public:
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        passLabel1->setText(QApplication::translate("AskPassphraseDialog", "      password", 0, QApplication::UnicodeUTF8));
        passLabel2->setText(QApplication::translate("AskPassphraseDialog", "   New password", 0, QApplication::UnicodeUTF8));
        passLabel3->setText(QApplication::translate("AskPassphraseDialog", "Repeat new password", 0, QApplication::UnicodeUTF8));
