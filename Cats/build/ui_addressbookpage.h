...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->resize(928, 507);
        ...
        QRCode = new QPushButton(AddressBookPage);
        QRCode->setObjectName(QString::fromUtf8("QRCode"));
        QRCode->setFont(font);
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/"), QSize(), QIcon::Normal, QIcon::Off);
        QRCode->setIcon(icon2);

        horizontalLayout->addWidget(QRCode);
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        QRCode->setText(QApplication::translate("AddressBookPage", "&QR Code", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a Cats address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified Cats address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
