...
public:
    ...
    catscoinAmountField *transactionFee;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        catscoinAtStartup = new QCheckBox(tabMain);
        catscoinAtStartup->setObjectName(QString::fromUtf8("catscoinAtStartup"));

        verticalLayout_Main->addWidget(catscoinAtStartup);
        ...
        transactionFee = new catscoinAmountField(tabWallet);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        catscoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Cats after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        catscoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Cats on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Cats client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Cats network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Cats.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Cats addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
